...
print("----------- RR -------------")
print("Output as data cube which is not very Pythonic:")
...
print("----------- DET ------------")
output_DET = rqa.DET(input_data, tau_values, emb_values, lmin_values, threshold_values, distance_type=rqa.accrqaDistance("maximal"), calculate_ENTR = True, comp_platform = rqa.accrqaCompPlatform("nv_gpu"), tidy_data = False)
...
print("----------- LAM ------------")
output_LAM = rqa.LAM(input_data, tau_values, emb_values, vmin_values, threshold_values, distance_type=rqa.accrqaDistance("maximal"), calculate_ENTR = True, comp_platform = rqa.accrqaCompPlatform("nv_gpu"), tidy_data = False)
