...
void GPU_RQA_R_matrix(int *R_matrix, float *h_input, unsigned long long int size, float threshold, int tau, int emb, int distance_type, int device, double *execution_time, int *error);
void GPU_RQA_R_matrix(int *R_matrix, double *h_input, unsigned long long int size, double threshold, int tau, int emb, int distance_type, int device, double *execution_time, int *error);


void GPU_RQA_diagonal_R_matrix(int *h_diagonal_R_matrix, float *h_input, float threshold, int tau, int emb, long int input_size, int distance_type, int device, double *execution_time, int *error);
void GPU_RQA_diagonal_R_matrix(int *h_diagonal_R_matrix, double *h_input, double threshold, int tau, int emb, long int input_size, int distance_type, int device, double *execution_time, int *error);
